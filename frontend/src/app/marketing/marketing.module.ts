...
import { MarketingActivityDetailComponent } from './shared/activity-detail/marketing-activity-detail.component';
                ...
                children: [
                    { path: 'dashboard', component: MarketingDashboardComponent },
                    {
                        ...
                        children: [
                            {
                                path: ':id',
                                component: MarketingInitiativeDetailComponent,
                                children: [
                                    { path: 'activity/:activityId', component: MarketingActivityDetailComponent, data: { mode: 'initiative' } },
                                ],
                            },
                        ],
                    },
                    { path: 'metrics', component: MarketingMetricsComponent },
                    {
                        ...
                        children: [{ path: ':id', component: MarketingProspectDetailComponent }],
                    },
                    {
                        path: 'workflows',
                        ...
                        children: [{
                            path: ':id',
                            component: MarketingWorkflowDetailComponent,
                            children: [
                                { path: 'activity/:activityId', component: MarketingActivityDetailComponent, data: { mode: 'workflow' } },
                            ],
                        }],
                    },
