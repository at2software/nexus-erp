...
Array.prototype.remove = function <T>(_: T) {
    this.splice(this.indexOf(_), 1);
    return this;
};
...
Array.prototype.contains = function <T>(_: T) {
...
String.prototype.formatPlaceholders = function () {
    return this.replace(/(\[.*?\])/g, '<code>$1</code>');
};