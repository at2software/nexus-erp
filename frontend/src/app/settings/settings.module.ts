...
import { SettingsProjectsStatesComponent } from './settings-projects/settings-projects-states/settings-projects-states.component';
import { SettingsConnectorsComponent } from './settings-connectors/settings-connectors.component';
...
@NgModule({
    ...
    imports: [
        RouterModule.forChild([
            {
                path: '',
                component: SettingsNavComponent,
                children: [
                    {
                        path: 'invoices',
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { path: 'states', component: SettingsProjectsStatesComponent },
                    ...
                    {
                        path: 'vault',
                        component: SettingsConnectorsComponent,
                    },
                    {
                        path: 'commands',
